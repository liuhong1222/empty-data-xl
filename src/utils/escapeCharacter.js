...
function trans2special (words) {
  if (typeof words === 'string') {
    var reg = new RegExp(`${transWordList.join('|')}`, 'g')
    return words.replace(reg, transWords => {
      return specialWordList.find((item, index) => transWordList[index] === transWords)
    })
  }
}

export default trans2special
