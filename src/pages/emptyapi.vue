    ...
    <div class="emptyapi-wrap">
      <div class="default-width info-regin">
        <div class="info-list">
          <h2>基本信息</h2>
          <div>当前余额（条）</div>
          <h3>{{ personalInfo.remainNumberTotal | thousandbit }}</h3>
          <a-button
            size="small"
          ...
          >
            ...
            <a-form-model-item prop="mobiles">
              ...
              <p style="line-height: 18px; margin-top: 10px">
                注:最多支持50个手机号码的测试，手机号之间用英文逗号分隔，不要有空格（否则无效）
              </p>
            </a-form-model-item>
            <a-form-model-item>
              <a-button
...
.banner-view {
  height: 530px;
  min-width: 1000px;
  background: url('../assets/index/emptyAPI.jpg') no-repeat center;
