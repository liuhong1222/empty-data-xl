  ...
  <div class="business">
    ...
    <div class="default-width cl-content-auth" v-if="status !== 'success'">
          ...
          <div v-show="customerType === 1" v-if="certType1">
            <a-form-item label="营业执照">
              ...
              'upload',
              {
                ...
                :action="`${dev?'/apis':''}/front/customer/businessLicenseUpload`"
                list-type="picture"
              >
              ...
              <div class="ant-form-extra">营业执照上传后，以下内容可自动识别</div>
              <div class="file-format">
                <p>附件要求：</p>
                <p><span>*</span>格式要求：扫描件需要使用jpg,jpeg,png图片格式
                </p>
                <p><span>*</span>内容要求：上传营业执照正面
                </p>
                <p><span>*</span>大小要求：不得超过5M
                </p></div>
            </a-form-item>
            ...
            <a-form-item label="营业执照号">
              <a-input
                v-decorator="['socialCreditCode', { rules: [{ required: true, message: '请输入营业执照' }] }]"
              />
            </a-form-item>
            ...
            <a-form-item label="法人名称">
              <a-input
                v-decorator="['legalPerson', { rules: [{ required: true, message: '请输入法人名称' }] }]"
              />
            </a-form-item>
            <a-form-item label="营业期限">
              <a-form-item class="timer-con" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
            ...
            -
              ...
              <a-form-item class="timer-con" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
                <a-input
                  placeholder="请输入结束时间"
                  style="width: 100%"
                  v-decorator="['validityTerm', { rules: [{ required: true, message: '请输入结束时间' }] }]"
                />
              </a-form-item>
            </a-form-item>
            <a-form-item label="经营范围">
              <a-textarea
                :autosize="{ minRows: 4 }"
                v-decorator="['businessScope', { rules: [{ required: true, message: '请输入经营范围' }] }]"
              />
            </a-form-item>
          </div>
          <div v-show="customerType === 0" v-if="certType0">
            <a-form-item label="身份证正面">
              <a-upload
                ...
                class="avatar-uploader"
                :showUploadList="false"
                :beforeUpload="(info)=>{beforeUpload(info, 'front')}"
                @change="(info)=>{imageChange(info, setFront, 'front')}"
                :data="fileParams"
                :headers="headers"
                v-decorator="[
              'idCardFrontPath',
              ...
              >
                ...
                <div class="upload-button" v-else>
                  ...
                  <span class="ant-upload-text">点击上传身份证正面</span>
                </div>
              </a-upload>
            </a-form-item>
            <a-form-item label="身份证反面">
              <a-upload
                ...
                class="avatar-uploader"
                :showUploadList="false"
                :beforeUpload="(info)=>{beforeUpload(info, 'back')}"
                @change="(info)=>{imageChange(info, setBack, 'back')}"
                :data="fileParams"
                :headers="headers"
                v-decorator="[
              'idCardBackPath',
              ...
              >
                ...
                <div class="upload-button" v-else>
                  ...
                  <span class="ant-upload-text">点击上传身份证反面</span>
                </div>
              </a-upload>
            </a-form-item>
            <a-form-item label="身份证号">
              <a-input
                v-decorator="['idCardNumber', { rules: [{ required: true, message: '请输入身份证号' }] }]"
              />
            </a-form-item>
            <a-form-item label="姓名">
              <a-input
                v-decorator="['idCardName', { rules: [{ required: true, message: '请输入姓名' }] }]"
              />
            </a-form-item>
            <a-form-item label="住址">
              <a-input
                v-decorator="['idCardAddress', { rules: [{ required: true, message: '请输入住址' }] }]"
              />
            </a-form-item>
            <a-form-item label="身份证有效期" required>
              <a-form-item class="timer-con" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
                <a-input
                  placeholder="请输入结束时间"
                  style="width: 100%"
                  v-decorator="['idCardExpireStartTime', { rules: [{ required: true, message: '请输入开始时间' }] }]"
                />
              </a-form-item>
              <span :style="{ display: 'inline-block', width: '24px', textAlign: 'center' }">
            -
              ...
              <a-form-item class="timer-con" :style="{ display: 'inline-block', width: 'calc(50% - 12px)' }">
                <a-input
                  placeholder="请输入结束时间"
                  style="width: 100%"
                  v-decorator="['idCardExpireEndTime', { rules: [{ required: true, message: '请输入结束时间' }] }]"
                />
              </a-form-item>
            </a-form-item>
          </div>
          <a-form-item :wrapper-col="{ span: 12, offset: 6 }">
            <a-button type="primary" html-type="submit" class="submitbtn" @click="handleSubmit">
              提交认证
            </a-button>
          </a-form-item>
        </a-form>
      ...
      <template v-else-if="status === 'submited'">
        <div class="bg-regin"><h3><img src="../assets/index/P023.png">您的认证正在等待审核，请耐心等待.....
        </h3>
          <p>注：（预计三个工作日内完成审核，快速过审请联系客服。）</p></div>
      </template>
    </div>
    <template v-else>
      <div data-v-b962fd1a="" class="default-width cl-content-done">
        <template v-if="customerType === 1">
          <div data-v-b962fd1a="" class="header">
            <h3 data-v-b962fd1a="">
              <img data-v-b962fd1a="" src="../assets/index/P024.png">已完成企业认证
            </h3></div>
          <h2 data-v-b962fd1a="">基本信息</h2>
          <form data-v-b962fd1a="" class="el-form">
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">公司名称：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.companyName}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">营业执照号：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.socialCreditCode}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">公司地址：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.address}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">法人名字：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.legalPerson}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">营业期限：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.establishmentDate+'至'+userAuthInfo.validityTerm}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">经营范围：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.businessScope}}</span>
                <!----></div>
            </div>
          </form>
        </template>
        <template v-if="customerType === 0">
          <div data-v-b962fd1a="" class="header">
            <h3 data-v-b962fd1a="">
              <img data-v-b962fd1a="" src="../assets/index/P024.png">已完成个人认证
            </h3></div>
          <h2 data-v-b962fd1a="">基本信息</h2>
          <form data-v-b962fd1a="" class="el-form">
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">身份证号：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.idCardNumber}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">姓名：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.idCardName}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">住址：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.idCardAddress}}</span>
                <!----></div>
            </div>
            <div data-v-b962fd1a="" class="el-form-item is-required"><label class="el-form-item__label"
                                                                            style="width: 170px;">身份证有效期：</label>
              <div class="el-form-item__content" style="margin-left: 170px;"><span data-v-b962fd1a="" class="text-show">{{userAuthInfo.idCardExpireStartTime+'至'+userAuthInfo.idCardExpireEndTime}}</span>
                <!----></div>
            </div>
          </form>
        </template>
...
export default {
  ...
  methods: {
          ...
          if (data.data.state === 0) {
            ...
            if (this.customerType === 1) {
              this.form.setFieldsValue({
                establishmentDate: userAuthInfo.businessLicenseExpireStartTime ? this.moment(userAuthInfo.businessLicenseExpireStartTime.substring(0, 4) + '-' + userAuthInfo.businessLicenseExpireStartTime.substring(5, 7) + '-' + userAuthInfo.businessLicenseExpireStartTime.substring(8, 10)) : '',
                address: userAuthInfo.companyAddress,
                businessScope: userAuthInfo.businessScope,
                legalPerson: userAuthInfo.legalPerson,
                companyName: userAuthInfo.companyName,
    ...
    async handleSubmit () {
      ...
      this.form.validateFields(async (err, values) => {
        if (!err) {
          ...
          if (this.customerType === 1) {
            params = {
              businessLicenseExpireStartTime: values.establishmentDate ? this.moment(values.establishmentDate).format('YYYY年MM月DD日') : '',
    ...
    beforeUpload (file, target) {
      ...
      if (!isJPG) {
        this.$message.error('You can only upload jpeg/png/jpg file!')
      }
...
<style lang="less">
  .business {
    ...
    .upload-button, .avatar-uploader > .ant-upload {
      width: auto;
      height: auto;
    }
