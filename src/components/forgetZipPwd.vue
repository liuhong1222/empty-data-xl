<template>
  ...
  >
    ...
    <div class="el-dialog__header">
      <span class="el-dialog__title">忘记解压密码</span>
    </div>
    <a-form :form="form" class="zip-form">
      ...
      <a-form-item class="newphone">
        <a-input
          ...
          placeholder="请确认新密码"
          style="width: 100%"
          v-decorator="['confirmPass', confirmPassRules]"
        />
      </a-form-item>
      <div class="remark">
        <p>
      ...
      this.form.validateFields(async (err) => {
        if (!err) {
          ...
          const params = {
            ...
            newUnzipPwdRepeat: this.form.getFieldValue('confirmPass'),
            verifySmsToken: this.verifyToken
          }
          // console.log(params)
          result = await server.forgetZipPassword(params)
