        ...
        >
          ...
          <a-form-item class="vertical-form" v-if="isShowVerticalCode">
            ...
            <div class="getVcodebtn" @click="getBase64Image">
              <img v-if="base64Image" :src="base64Image" alt="" style="margin-top: -14px;cursor: pointer">
          ...
          <a-form-item class="password-form">
            ...
            <a-button class="getcodebtn" :class="{'is-disabled': waitingtime}" type="link"
                      @click="sendSmsAndVerifyJyCode">{{waitingtime ?
              `${waitingtime}秒后可重发`: '获取验证码'}}
            </a-button>
          </a-form-item>
